...
import com.springbbox.common.service.GeneratorService;
import com.springbbox.common.utils.GenUtils;
...
public class GeneratorController {
	...
	public void code(HttpServletRequest request, HttpServletResponse response,
		...
		response.reset();
		response.setHeader("Content-Disposition", "attachment; filename=\"springbbox.zip\"");
